...
if(isset($_POST['search'])) {
  ...
  $list = $suiviC->searchsuiviById($search_query);
}
if(isset($_POST['tri'])) {
  $list = $suiviC->trisuiviByDiag();
}
...
<div class="row ">
  ...
  <center> 
    ...
    <form method="POST">
              <input type="text" placeholder="Enter ID suivi" name="search_query">
              <button type="submit" name="search"><i class="fa fa-search"></i></button>
            </form>

            <form method="POST">
    <button type="submit" name="tri">Trier par niveau d'état de diagnostic</button>
    
<form method="POST">
    <button type="submit" name="stat">Statistiques</button>
</form>
...
if(isset($_POST['stat'])) {
  $suiviC->generateSymptomesChart();
}

?>
  </center>
  <div id="symptomes_chart" style="width: 100%; height: 500px;"></div>
