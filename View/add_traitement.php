...
if (
  ...
  if (
    ...
    // create a new traitement object with the input values
    ...
    // add the traitement to the database
    $traitementT->add_traitement($traitement);
    

    header('Location:ListTraitement.php');
  } else {
...
<form action="ListTraitement.php">
...
toggle.addEventListener('click', function(){
  ...
  if(this.classList.toggle('bi-brightness-high-fill')){
      ...
      <form action="" method="POST"  onsubmit="return passValidation()" >
       ...
       <input type="text" name="type_T" id="type_T" placeholder="Treatment Type" pattern="[A-Za-z\- ]+" minlength="3" maxlength="25" required />
       
       <input type="text" name="duree_T" id="duree_T" placeholder="Treatment Duration" minlength="3" maxlength="25" required />

       <input type="number" name="cin_p"  value="<?php echo $_GET['cin_p']; ?>" id="cin_p"  />
        ...
        <button type="submit" value="Signup" onclick="passValidation ()">ADD</button>
