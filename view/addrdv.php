    ...
    <div class="appointment-form">
        ...
        <form  action="" method="POST">
            ...
            <script>
               ...
               <a href="paiment.html">
                  <input type="button" class="btn-submit" data-wow-delay="0.39s" onclick="appset()"value="Validé"> </a>

               <button type="submit" data-wow-delay="0.39s" class="btn-submit">Cancel
               </button>
        ...
        /*    const form = document.querySelector('form');
            form.addEventListener('submit', (event) => {
                ...
                const email = document.querySelector('#email_r').value;
            ...
            function aa() {
                var dialog = confirm("Paiment en ligne ?");
                if (dialog) {
                    console.log("online");
                    window.location.replace("paiment.html")
                }
                else {
                    console.log("raj3ni");
